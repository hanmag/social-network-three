...
Globe = function (webglGroup, cssGroup, camera, raycaster) {
    ...
    var ps = new ParticleSystem(particleGroup);
...
(function () {
    ...
    function initScene() {
        ...
        // globe
        globe = new Globe(webglGroup1, cssGroup1, camera, raycaster);
